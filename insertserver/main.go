...
func main() {
	...
	router.HandleFunc("/restart/{authid}", restartApp).Methods("GET")
...
// A function that restarts the heroku application when requested
func restartApp(res http.ResponseWriter, request *http.Request) {
